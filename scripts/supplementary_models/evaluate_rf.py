#!/usr/bin/env python3
"""Evaluate a Random Forest artifact on the held-out predefined test split."""
...
def main() -> None:
    ...
    model_path = args.model_path or Path("artifacts/random_forest") / args.dataset / "model.joblib"
